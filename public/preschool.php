...
$page = "Preschool Program for 2's | 3's | 4's";
openHeader($page);
closeHeader();
drawMainMenu();
...
<div>
  ...
  <p class='pgraph'>Our philosophy is to provide opportunities for our children to grow socially, emotionally and intellectually in a warm, loving and nurturing environment. We believe children learn through hands on activities and exploration through the arts and nature. Children will be exposed to a wide variety of programming which will engage them in a play based learning environment with a strong sense of age appropriate academics. Our little students learn to become self-reliant and develop a strong self-image as we encourage everyone's various learning styles and interests. The incredible connection between children and animals promotes the love of nature and the outside world which is especially valuable in a city environment.</p>

  <p class='pgraph'>Throughout the day the children are encouraged to socialize with their peers and work together in a classroom setting. Our program runs from September through June.</p>

  <span class='subtitle1 bold' style='color:#CC0000'>Curriculum</span>
  <p class='pgraph'>
    Our 2's and 3's is based on a monthly theme curriculum with a focus on 
    colors, shapes, numbers and letters. Our 4's is based on The New York State
    Universal Pre-K Standards.
  </p>

  <span class='subtitle1 bold' style='color:#0066FF'>Daily Live Animal Science Lessons</span>
  <p class='pgraph'>
    Every day in school a live animal will visit your child's classroom. The 
    teachers will teach the children how to hold pet the animal as well as 
  ...
  <p class='pgraph'>
    ...
    program for young children. Half of the school you're your child will get 
  ...
  <p class='pgraph'>
    ...
    organic ingredients and their own cooking utensils. We promote healthy eating
    habits when cooking in our kitchen and during snack time, and we also teach 
    them how to recycle.
  </p>
